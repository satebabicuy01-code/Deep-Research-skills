#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Mengubah results/*.json menjadi report.md (katalog tuas desain fasad), sesuai skill research-report."""
...
CATEGORY_TITLES = {
    ...
    "performance_metrics": "Bukti & Besaran Efek",
    "implications": "Implikasi & Pengukuran",
}
SUMMARY_FIELDS = ["lever_type", "evidence_strength"]
...
def main():
    ...
    lines = [
        f"# {OUTLINE['topic']}",
        "",
        f"Katalog tuas desain fasad (hasil `/research-deep`). Audiens: {OUTLINE['audience']}. "
